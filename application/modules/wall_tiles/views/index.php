							...
							<div class="product-grid">
								<?php 
									foreach($wall_tiles as $tile) {
										...
										?>
											<div class="product-item <?php echo strtolower($tile['colour']).' '.strtolower($tile['finish']).' '.str_replace(' ', '-', strtolower($tile['size'])).' '.str_replace(' ', '-', strtolower($tile['application'])) ;?>" onclick='location.href="/wall-tiles/details/<?php echo $tile['id'];?>"'>
